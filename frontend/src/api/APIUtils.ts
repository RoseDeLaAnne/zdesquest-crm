...
export const getQuestProfit = async (id: number) => {
  try {
    const url = `http://crm.zdesquest.ru/api/quest-profit/${id}/`;
...
export const getUserSTQuests = async (startDate: string, endDate: string) => {
  try {
    ...
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/user/stquests/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/user/stquests/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getQuestVersions = async () => {
  try {
    const url = `http://crm.zdesquest.ru/api/quest-versions/`;
    const response = await axios.get(url);
    return response;
  } catch (error) {
    throw error;
...
export const getQuestIncomes = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/incomes/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/incomes/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getQuestExpenses = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/expenses/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/expenses/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getCurrentSalaries = async (startDate: string, endDate: string) => {
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/salaries/current/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/salaries/current/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getQuestCashRegister = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/cash-register/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/cash-register/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getWorkCardExpenses = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/work-card-expenses/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/work-card-expenses/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getExpensesFromTheir = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/expenses-from-their/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/expenses-from-their/`;
    }
    const response = await axios.get(url);
    return response;
  } catch (error) {
...
export const getQVideos = async (
  ...
  try {
    let url;
    if (startDate !== null && endDate !== null) {
      url = `http://crm.zdesquest.ru/api/quest/${id}/videos/?start_date=${startDate}&end_date=${endDate}`;
    } else {
      url = `http://crm.zdesquest.ru/api/quest/${id}/videos/`;
    }
...
export const getQuestVersion = async (id: number) => {
  try {
    const url = `http://crm.zdesquest.ru/api/quest-version/${id}/`;
    const response = await axios.get(url);
    return response;
  } catch (error) {
    throw error;
...
export const postQuestVersion = async (value: object) => {
  try {
    const url = `http://crm.zdesquest.ru/api/create/quest-version/`;
    const response = await axios.post(url, value);
    return response;
  } catch (error) {
    throw error;
