  ...
  return (
    <Form name="form_item_path" layout="vertical" onFinish={onFinish}>
      ...
      <MyFormItem name="quest" label="Квест">
        <Select options={optionsQuest} placeholder="Please select" />
      </MyFormItem>
      ...
      <MyFormItem name="roomName" label="Название комнаты">
        <Input />
      </MyFormItem>
      ...
      <MyFormItem name="administrator" label="Администратор">
        <Select options={optionsAdministrator} placeholder="Please select" />
      </MyFormItem>
      ...
      <MyFormItem name="animator" label="Аниматор">
        <Select options={optionsAnimators} placeholder="Please select" />
      </MyFormItem>
