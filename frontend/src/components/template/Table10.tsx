...
import { getQuestProfit } from "../../api/APIUtils";
...
const TableFC: FC = ({
  ...
  const getQuestProfitById = async () => {
    const res = await getQuestProfit(id)
    console.log(res.data.total)

    setTitle(`${breadcrumbItems[breadcrumbItems.length - 2].title} | ${
