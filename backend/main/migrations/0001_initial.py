    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_versions', models.ManyToManyField(blank=True, to='main.quest')),
            ],
        ),
        migrations.CreateModel(
            name='QuestVersion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_from', models.CharField(blank=True, choices=[('work_card', 'рабочая карта'), ('their', 'свои'), ('cash_register', 'касса')], max_length=255, null=True)),
                ('who_paid_amount', models.IntegerField(blank=True, null=True)),
                ('attachment', models.FileField(blank=True, null=True, upload_to='photos/')),
                ('paid_tax', models.ManyToManyField(blank=True, related_name='paid_tax_users', to=settings.AUTH_USER_MODEL)),
                ('quest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quest_stexpense', to='main.quest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_with_staj', models.ManyToManyField(blank=True, related_name='employee_with_staj_stquest', to=settings.AUTH_USER_MODEL)),
